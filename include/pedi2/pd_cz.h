...
#define pdCZLambda(cz)    pdCZHrzLambda( pdCZHrzPtr(cz) )
#define pdCZCanonDist(cz) pdCZHrzCanonDist( pdCZHrzPtr(cz) )
...
#define pdCZSetLambda(cz,l)        pdCZHrzSetLambda( pdCZHrzPtr(cz), l )
#define pdCZSetCanonDist(cz,d)     pdCZHrzSetCanonDist( pdCZHrzPtr(cz), d )
