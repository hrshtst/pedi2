...
#define pdCZHrzCanonDist(h)    pdCZHrzUWCanonDist( pdCZHrzUWPtr(h) )
...
#define pdCZHrzSetCanonDist(h,d)    pdCZHrzUWSetCanonDist( pdCZHrzUWPtr(h), d )
#define pdCZHrzSetPrm(h,vud,qu1,qu2,vwd,qw1,qw2,rho,kr,dist,kappa,lambda,dist0) \
